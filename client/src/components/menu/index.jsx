            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-4 col-sm-6">
                        {/* MENU THUMB */}
                        <div className="menu-thumb">
                            <a href="images/menu-image2.jpg" className="image-popup" title="Self-made Salad">
                    ...
                    <div className="col-md-4 col-sm-6">
                        {/* MENU THUMB */}
                        <div className="menu-thumb">
                            <a href="images/menu-image3.jpg" className="image-popup" title="Chinese Noodle">
                    ...
                    <div className="col-md-4 col-sm-6">
                        {/* MENU THUMB */}
                        <div className="menu-thumb">
                            <a href="images/menu-image4.jpg" className="image-popup" title="Rice Soup">
                    ...
                    <div className="col-md-4 col-sm-6">
                        {/* MENU THUMB */}
                        <div className="menu-thumb">
                            <a href="images/menu-image5.jpg" className="image-popup" title="Project title">
                    ...
                    <div className="col-md-4 col-sm-6">
                        {/* MENU THUMB */}
                        <div className="menu-thumb">
                            <a href="images/menu-image6.jpg" className="image-popup" title="Project title">
